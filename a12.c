/* Das Programm soll jedes Zeichen gegen ein anderes Zeichen ersetzen, so wie in einer Codetabelle festgelegt, welche über die Parameter der Kommandozeile mitgegeben wird. */
#include <stdio.h>
#include <stdlib.h>
